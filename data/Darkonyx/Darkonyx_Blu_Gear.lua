function user_job_setup()
	...
	state.Weapons:options('Naegbron')
...
relic = {}
    relic.Head = "Luh. Keffiyeh +2"
    relic.Body = "Luhlaza Jubbah +2"
    relic.Hands = "Luh. Bazubands +2"
    relic.Legs = "Luhlaza Shalwar +1"
    relic.Feet = "Luhlaza Charuqs +2"
...
--	sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {body="Passion Jacket"})
	...
	sets.precast.FC['Blue Magic'] = set_combine(sets.precast.FC, {body=empy.Body})
...
--		back="Cornflower Cape",waist="Acuity Belt +1",legs="Assim. Shalwar +3",feet="Malignance Boots"}
	...
	sets.weapons.Naegbron = {main="Naegling",sub="Machaera"}
	...
	sets.engaged.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Acc = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Acc.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.FullAcc = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.FullAcc.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Fodder = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Fodder.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.DT = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.DT.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Acc.DT = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Acc.DT.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.FullAcc.DT = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Fodder.DT = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
	...
	sets.engaged.Fodder.DT.AM = {main="Naegling",sub="Machaera",
				ammo="Ginsen",
			    head="Malignance Chapeau",
				neck="Mirage Stole +1",
				ear1="Brutal Earring",
