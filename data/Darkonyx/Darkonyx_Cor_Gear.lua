...
function user_job_setup()
    ...
    gear.RAbullet = "Oberon's Bullet"
    gear.WSbullet = "Oberon's Bullet"
    gear.MAbullet = "Oberon's Bullet" --For MAB WS, do not put single-use bullets here.
    gear.QDbullet = "Oberon's Bullet"
...
function init_gear_sets()
    ...
    --------------------------------------
    gear.Empy = {}
    gear.Empy.Head = "Chasseur's Tricorne +3"
    gear.Empy.Body = "Chasseur's Frac +3"
    gear.Empy.Hands = "Chasseur's Gants +3"
    gear.Empy.Legs = "Chasseur's Culottes +3"
    gear.Empy.Feet = "Chasseur's Bottes +3"
    ...
    sets.precast.CorsairRoll = {
		main={ name="Lanun knife", augments={'Path: C',}}, -- +8 Effect and 60 sec Duration
		sub= "Nusku shield",
		range="Compensator", -- 20 sec Duration
		head="Lanun Tricorne", -- 50% Job ability Bonus
		--hands=gear.Empy.Hands, --60 sec Duration
		--legs="Desultor Tassets", --Phantomroll ability delay -5
		--neck={ name="Regal necklace", bag="Wardrobe 5", priority=1}, -- 20 sec Duration
    ...
    sets.precast.CorsairRoll["Bolter's Roll"] = {
        main={ name="Rostam", augments={'Path: C'}, bag="Wardrobe 5", priority=1}, -- +8 Effect and 60 sec Duration
    }
    ...
    sets.precast.FC = {
		...
		back={ name="Camulus's Mantle", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}}, -- 10
    }
    ...
    sets.weapons.Default = { main = "Naegling", sub = "Nusku Shield", range = "Holliday"} 
	sets.weapons.Savage = {
        main = "Naegling", 
        sub = "Nusku Shield", 
    ...
    sets.weapons.DualWeapons = { 
		main = "Naegling", sub = "Demersal degen +1", range = "Magnatus"
	}
